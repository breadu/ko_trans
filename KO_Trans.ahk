...
LoadProfileSettings(forceProc := "") {
    ...
    OCR_Y := IniRead(INI_FILE, targetProc, INI_OCR_Y, IniRead(INI_FILE, PROFILE_SETTINGS, INI_OCR_Y, DEFAULT_OCR_Y))
    OCR_W := IniRead(INI_FILE, targetProc, INI_OCR_W, IniRead(INI_FILE, PROFILE_SETTINGS, INI_OCR_W, DEFAULT_OCR_W))
    OCR_H := IniRead(INI_FILE, targetProc, INI_OCR_H, IniRead(INI_FILE, PROFILE_SETTINGS, INI_OCR_H, DEFAULT_OCR_H))
    OCR_LANG := IniRead(INI_FILE, targetProc, INI_LANG, IniRead(INI_FILE, PROFILE_SETTINGS, INI_LANG, DEFAULT_LANG))
    ...
    OVERLAY_OPACITY := IniRead(INI_FILE, targetProc, INI_OVERLAY_OPACITY, IniRead(INI_FILE, PROFILE_SETTINGS, "OVERLAY_OPACITY", DEFAULT_OVERLAY_OPACITY))
    OVERLAY_FONT_SIZE := IniRead(INI_FILE, targetProc, INI_OVERLAY_FONT_SIZE, IniRead(INI_FILE, PROFILE_SETTINGS, "OVERLAY_FONT_SIZE", DEFAULT_OVERLAY_FONT_SIZE))
    OVERLAY_FONT_COLOR := IniRead(INI_FILE, targetProc, INI_OVERLAY_FONT_COLOR, IniRead(INI_FILE, PROFILE_SETTINGS, "OVERLAY_FONT_COLOR", DEFAULT_OVERLAY_FONT_COLOR))

    ; Load API Keys from Global section
    GEMINI_API_KEY := IniRead(INI_FILE, PROFILE_SETTINGS, INI_GEMINI_API_KEY, "")
    OPENAI_API_KEY := IniRead(INI_FILE, PROFILE_SETTINGS, INI_OPENAI_API_KEY, "")

    ; Dictionary settings
    CHAR_DICT_ENABLED := IniRead(INI_FILE, targetProc, INI_CHAR_DICT_ENABLED, IniRead(INI_FILE, PROFILE_SETTINGS, INI_CHAR_DICT_ENABLED, DEFAULT_CHAR_DICT_ENABLED))
    CHAR_DICT_PATH := IniRead(INI_FILE, targetProc, INI_CHAR_DICT_PATH, IniRead(INI_FILE, PROFILE_SETTINGS, INI_CHAR_DICT_PATH, DEFAULT_CHAR_DICT_PATH))
